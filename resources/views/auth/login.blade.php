                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                <div class="brand-logo pb-5">
                                    <a href="{{url("/")}}" class="logo-link">
                                        <img class="logo-light logo-img" src="{{asset("docs/images/logo.png")}}" alt="logo">
                                        <img class="logo-dark logo-img" src="{{asset("docs/images/logo-dark.png")}}" alt="logo-dark">
                                    </a>
                                </div>
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-lg" id="default-01" name="email" placeholder="Enter your email address or username">
                                    </div><!-- .foem-group -->
                                    <div class="form-group">
                                        <div class="form-label-group">
